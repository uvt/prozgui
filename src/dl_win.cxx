...
dl_gui::dl_gui():Fl_Window(547,398) {
  ...
  { Fl_Window* o = dl_win = this;
    ...
    o->icon((char *) pixmap);
#endif
    { Fl_Button* o = resume_later_button = new Fl_Button(425, 365, 100, 25, gettext("Stop"));
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_dlwin_resume_later, (void*)(this));
      o->align(FL_ALIGN_WRAP|FL_ALIGN_INSIDE);
    }
    { Fl_Button* o = pause_button = new Fl_Button(25, 365, 100, 25, gettext("Pause"));
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_dlwin_pause, (void*)(this));
      o->align(FL_ALIGN_WRAP|FL_ALIGN_INSIDE);
      o->deactivate();
    }
    { Fl_Button* o = no_resume_later_button = new Fl_Button(225, 365, 100, 25, gettext("Abort"));
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_dlwin_no_resume_later, (void*)(this));
      o->align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
      o->hide();
    }
    { Fl_Output* o = url_box = new Fl_Output(50, 10, 475, 25, gettext("URL:"));
    ...
    { Fl_Output* o = resume_status_box = new Fl_Output(300, 200, 225, 25);
      o->box(FL_BORDER_BOX);
      o->color(49);
      o->labelsize(12);
      o->textsize(12);
    }
    { Fl_Output* o = file_size_box = new Fl_Output(25, 200, 225, 25);
      o->box(FL_BORDER_BOX);
      o->color(49);
      o->labelsize(12);
      o->textsize(12);
    }
    { Fl_Output* o = bytes_recv_box = new Fl_Output(25, 155, 225, 25);
      o->box(FL_BORDER_BOX);
      o->color(49);
      o->labelsize(12);
      o->textsize(12);
    }
    { Fl_Browser* o = browser = new Fl_Browser(20, 275, 510, 85);
    ...
    { Fl_Output* o = est_time_box = new Fl_Output(300, 245, 225, 25);
      o->box(FL_BORDER_BOX);
      o->color(49);
      o->labelsize(12);
      o->textsize(12);
    ...
    { Fl_Scroll* o = scroll_win = new Fl_Scroll(20, 45, 510, 100);
      o->box(FL_ENGRAVED_BOX);
      o->labelsize(12);
      o->end();
    }
    progress_box = new Fl_Progress(300,155,225,25,0);
    o->show();
    o->end();
  }
}
