...
/* $Id: prozilla.h,v 1.57 2001/10/27 11:24:40 kalum Exp $ */
/* $Id: prozilla.h,v 1.58 2011/03/24 11:24:40 ahmad Exp $ */
...
/* Structure containing info on a URL. */
  ...
  typedef struct connection_t {
    ...
    long long remote_startpos;
    long long orig_remote_startpos;
    long long remote_endpos;
    long long remote_bytes_received;

    long long main_file_size;
...
/*Functions that set values which will apply for all conenctions. */
  ...
  char *proz_get_libprozgui_version();
...
/*Functions which are for handling a  single connection. */
  ...
  long long proz_connection_get_total_bytes_got(connection_t * connection);
  void proz_get_url_info_loop(connection_t * connection, pthread_t *thread);
  long long proz_connection_get_total_remote_bytes_got(connection_t *
						  connection);
...
ftps_request_t * proz_ftps_request_init(
			       urlinfo * requested_url, long long file_size,
			       char *ftps_loc,
			       ftpsearch_server_type_t server_type,
			       int num_req_mirrors);
